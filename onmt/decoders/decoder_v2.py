...
class RNNDecoderBase(DecoderBase):
    ...
    def __init__(self, rnn_type, bidirectional_encoder, num_layers,
        ...
        if context_gate is not None:
            if self.pass_user_context_to_gate:
                self.context_gate = context_gate_factory(
                    context_gate, self._input_size,
                    hidden_size, hidden_size, hidden_size, context_hidden_size
                )
            else:
                self.context_gate = context_gate_factory(
                    context_gate, self._input_size,
                    hidden_size, hidden_size, hidden_size, None
                )
    ...
    def forward(self, tgt, memory_bank, user_context_vec=None, memory_lengths=None, step=None):
        """
        Args:
        ...
        dec_state, dec_outs, attns = self._run_forward_pass(
            tgt, memory_bank, user_context_vec, memory_lengths=memory_lengths)
...
class StdRNNDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank, user_context_vec=None, memory_lengths=None):
        """
    ...
    def _input_size(self):
        return self.embeddings.embedding_siz
            ...
            if self.context_gate is not None:
                ...
                if self.pass_user_context_to_gate:
                    decoder_output = self.context_gate(
                        decoder_input, rnn_output, decoder_output, user_context_vec
                    )
                else:
